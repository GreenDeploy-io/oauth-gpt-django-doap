...
This repository uses `oauth-gpt-django-doap` as project name.
...
This step will create the virtual environment (henceforth venv for short) `/path/to/your/project/.venv/oauth-gpt-django-doap-31013` and then create a symlink `/path/to/your/project/.venv/oauth-gpt-django-doap` pointing to this venv.
...
1. run `source ~/.venv/oauth-gpt-django-doap/bin/activate` to turn on the virtual environment
